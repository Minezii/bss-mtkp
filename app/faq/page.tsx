...
const faqs = [
    ...
    },
    {
        ...
        a: 'Для отслеживания статуса достаточно войти в свой аккаунт — все твои заявки появятся в разделе "Статус" автоматически. Если ты отправлял заявку без регистрации, ты всё еще можешь проверить её по уникальному UUID, который был выдан в конце.'
    }
];
